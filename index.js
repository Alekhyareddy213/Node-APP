    ...
    */
    ...
    if (req.url === '/') {
        ...
        async function main(){
            ...
            const uri ="mongodb+srv://Alekhya:Alekhya@bankmanagement.4flkies.mongodb.net/?retryWrites=true&w=majority&appName=BankManagement"
        ...
        async function findsomedata(client ){
            const cursor = client.db("BankManagement").collection("Details").find({});
...
server.listen(6105, () => console.log("My server is running"));